...
export function msgpack_decode(data) {
    ...
    function readInt8() { if (offset + 1 > bytes.length) throw new RangeError("MessagePack: truncated or malformed input"); const v = view.getInt8(offset); offset += 1; return v; }
    function readUint16() { if (offset + 2 > bytes.length) throw new RangeError("MessagePack: truncated or malformed input"); const v = view.getUint16(offset); offset += 2; return v; }
    function readInt16() { if (offset + 2 > bytes.length) throw new RangeError("MessagePack: truncated or malformed input"); const v = view.getInt16(offset); offset += 2; return v; }
    function readUint32() { if (offset + 4 > bytes.length) throw new RangeError("MessagePack: truncated or malformed input"); const v = view.getUint32(offset); offset += 4; return v; }
    function readInt32() { if (offset + 4 > bytes.length) throw new RangeError("MessagePack: truncated or malformed input"); const v = view.getInt32(offset); offset += 4; return v; }
    function readFloat32() { if (offset + 4 > bytes.length) throw new RangeError("MessagePack: truncated or malformed input"); const v = view.getFloat32(offset); offset += 4; return v; }
    function readFloat64() { if (offset + 8 > bytes.length) throw new RangeError("MessagePack: truncated or malformed input"); const v = view.getFloat64(offset); offset += 8; return v; }
    function readUint64() {
