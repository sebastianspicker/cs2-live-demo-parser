...
class UIController {
    ...
    updateConnectionStatus(connected) {
        if (connected) {
            ...
            if (this.statusText) this.statusText.textContent = "Disconnected - reconnecting ...";
            if (this.headerStatus) this.headerStatus.textContent = "Disconnected";
        }
    }
...
class CS2BroadcasterClient {
    constructor() {
        ...
        this.layoutMode = loadLayoutMode();
    ...
    connect() {
        ...
        this.ws.onclose = () => {
            ...
            if (this.ui.statusText) {
                this.ui.statusText.textContent = `Disconnected - retrying in ${delaySec}s ...`;
            }
