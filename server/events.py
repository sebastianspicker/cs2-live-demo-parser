...
class EventCollector:
    def __init__(self, demo_parser):
        ...
        self.last_bomb_defused_tick = 0
        self.last_bomb_exploded_tick = 0
    ...
    def refresh(self, max_tick: Optional[int] = None) -> None:
        ...
        defused_df = self._get_new_events("bomb_defused", "last_bomb_defused_tick", max_tick)
        exploded_df = self._get_new_events("bomb_exploded", "last_bomb_exploded_tick", max_tick)
